"""
Given a 0-indexed integer array nums, write a function left_right_difference 
...
left_sum[i] is the sum of elements to the 
left of the index i in the array nums. 
